...
class FolderMonitor:
    ...
    def detect_changes(self):
        while True:
            ...
            if (current_time - self.snapshot_time).total_seconds() > 5:
...
if __name__ == "__main__":
    folder_path = "C:\\Users\\rudin\\BrawlhallaReplays"
    ...
    while True:
        print("Enter one of the following commands: commit , info <filename> , status , exit")
        command = input(">")
        if command == "commit":
